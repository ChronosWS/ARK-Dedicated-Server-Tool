...
namespace ARK_Server_Manager.Lib
{
    public static class GameData
    {
        private static readonly DinoSpawn[] dinoSpawns = new DinoSpawn[] 
            {
                new DinoSpawn { ClassName="Ankylo_Character_BP_C",          DinoNameTag = "Ankylosaurus",       SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Ant_Character_BP_C",             DinoNameTag = "Titanomyrma",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Argentavis_Character_BP_C",      DinoNameTag = "Argentavis",         SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="BigFoot_Character_BP_C",         DinoNameTag = "Gigantopithecus",    SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Sauropod_Character_BP_C",        DinoNameTag = "Brontosaurus",       SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Carno_Character_BP_C",           DinoNameTag = "Carnotaurus",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Coel_Character_BP_C",            DinoNameTag = "Coelacanth",         SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Dilo_Character_BP_C",            DinoNameTag = "Dilophosaur",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="Dimorph_Character_BP_C",         DinoNameTag = "Dimorphodon",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Dolphin_Character_BP_C",         DinoNameTag = "Ichthy",             SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Megalodon_Character_BP_C",       DinoNameTag = "Megalodon",          SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="MegaCarno_Character_BP_C",       DinoNameTag = "Alpha Carno",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="MegaRaptor_Character_BP_C",      DinoNameTag = "Alpha Raptor",       SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="MegaRex_Character_BP_C",         DinoNameTag = "Alpha Rex",          SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Para_Character_BP_C",            DinoNameTag = "Parasaur",           SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Ptero_Character_BP_C",           DinoNameTag = "Pteranodon",         SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Stego_Character_BP_C",           DinoNameTag = "Stegosaurus",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Trike_Character_BP_C",           DinoNameTag = "Triceratops",        SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                ...
                new DinoSpawn { ClassName="Turtle_Character_BP_C",          DinoNameTag = "Carbonemys",         SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
                new DinoSpawn { ClassName="SpiderL_Character_BP_C",         DinoNameTag = "Broodmother Lysrix", SpawnWeightMultiplier = 0.1F, OverrideSpawnLimitPercentage = true, SpawnLimitPercentage = 1.0F },
            };
